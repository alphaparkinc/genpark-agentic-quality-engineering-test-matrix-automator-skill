# genpark-agentic-quality-engineering-test-matrix-automator-skill
...
> **GenPark AI Agent Skill** -- Agentic QE, self-healing test automation & coverage matrix (TestMu style)
